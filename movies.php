...
$sql0= "UPDATE movies SET active = 0, poster = 'No', downloaded = 'No'";
$conn->query($sql0);
...
foreach ($dir as $fileinfo) {
	...
	if (!(($ext == "php") || ($ext == "jpg") || ($ext == "css") || ($ext == "sh") || ($ext == "js") || (strpos($filename,"Z_seen") !== false) || (strpos($filename,".git") !== false) || (strpos($filename,".gitignore") !== false))) {
...
<?php
// Showing the movies
$sql3 = "SELECT * FROM movies WHERE active = '1'";
...
<?php
// Showing the movies
$sql3 = "SELECT * FROM movies WHERE active = '0'";
$result3 = $conn->query($sql3);
